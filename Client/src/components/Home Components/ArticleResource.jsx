  ...
  return (
    <>
      ...
      <section className="w-full p-8 bg-white">
        <container className="container mx-auto bg-CTA p-32 flex items-center flex-col">
          <container className="flex flex-col items-center my-8">
          ...
          <p className="text-headerBackground w-1/2">Making this the first true value generator on the Internet. It has over 200 latin words, combined with a handful</p>
          <container className="flex items-center gap-3 mt-4">
            <input type="text" placeholder="Your Email id..." className="w-[500px] py-4 px-6 rounded-md" />
